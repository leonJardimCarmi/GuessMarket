...
public class LmsrCalculator {
    ...
    public static double calculateCostFunction(List<Outcome> outcomes){
    ...
    public static double calculatePurchaseCost(List<Outcome> outcomes, String targetOutcomeTitle, double amountToBuy){
        if( amountToBuy <= 0 ){
            throw new IllegalArgumentException("Amount to buy be greater than zero. ");
        }

        double currentCost = calculateCostFunction(outcomes);
    ...
    public static double calculatePrice(List<Outcome> outcomes, String targetOutcomeTitle){
    ...
    public static double calculateFee(double amount, double feePercentage){
